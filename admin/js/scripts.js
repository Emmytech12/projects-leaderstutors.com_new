...
function _proceed_reset_password() {
  ...
  $("#reset_pass_email").removeClass("complain");
    ...
    $("#reset_pass_email").addClass("complain");
      $("#warning-div").html('<div><i class="bi-exclamation-octagon-fill"></i></div> EMAIL ERROR!<br /><span>Fill Correct Email Address To Continue </span>').fadeIn(500).delay(5000).fadeOut(100);
    } else {
    $("#reset_pass_email").removeClass("complain");
...
function _comfirmed_reset_password(staff_id) {
 ...
 if (otp == "") {
    ...
    $("#warning-div").html('<div><i class="bi-exclamation-octagon-fill"></i></div> OTP Error!  <br /><span> Kindly Fill fields to continue. </span>').fadeIn(500).delay(5000).fadeOut(100);
  } else if (password == "") {
    $("#password").addClass("complain");
    $("#warning-div").html('<div><i class="bi-exclamation-octagon-fill"></i></div> Create New Password Error <br /><span> Kindly Fill fields to continue. </span>').fadeIn(500).delay(5000).fadeOut(100);
  }else if(confirm_password== ""){
    $("#confirm_password").addClass('complain');
    $("#warning-div").html('<div><i class="bi-exclamation-octagon-fill"></i></div> Confirm New Password Error <br /><span> Kindly Fill fields to continue.</span>').fadeIn(500).delay(5000).fadeOut(100);
