...
<?php if ($page=='dashboard'){?>
        <div class="statistics-back-div">
            ...
            <div class="statistics-div bg2" onClick="_get_page('active_users', 'user')" id="user">
                <div class="inner-div">                    
                    Active Users <br>
                    <span class="number" id="total_active_user">0</span>
                </div>
            </div>          
...
<?php if ($page=='all_department'){?>
    ...
    <div class="alert alert-success"> <span><i class="bi-people-fill"></i></span> DEPARTMENT'S LIST <button class="btn" onClick="_get_form('dept_reg')"><i class="bi-plus-square"></i> CREATE A DEPARTMENT</button></div>
