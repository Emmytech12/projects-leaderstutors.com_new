<?php if ($page == 'dashboard') { ?>
    ...
    <div class="table-div animated fadeIn" id="search-content">
        <div class="div-in">
            ...
            <div id="fetch_department_class_subject_details">
    ...
    <div class="table-div animated fadeIn" id="search-content">
        <div class="div-in">
            ...
            <div class="profile-container">
                ...
                <div class="profile-grid-details profile-grid-details2" style="margin-bottom: 0px; float:left;">
                    <div class="grid-details">
        ...
        <div class="div-in">
            ...
            <div class="profile-container">
                <div class="profile-grid-details">
                    <div class="grid-details">
                        Referral Code:
                        <div class="text" id="user_referral_code">000000</div>
                    </div>
                </div>
            ...
            <div class="profile-container">
                <div class="profile-grid-details" style="margin-bottom: 0px">
                    <div class="grid-details">
                        Registration Date:
                ...
                <!-- <div class="profile-grid-details details2" style="margin-bottom: 0px">
                        <div class="grid-details">
                            <div class="referral-div">
                                Referral Code:
                                <div class="text" id="textToCopy">23453564 </div>
                            </div>
                            <div class="icon-div" onclick="_copyText()" id="copyText"> <i class="bi bi-clipboard"></i> </div>
                        </div>
                    </div> -->
            </div>
