...
<link href="<?php echo $website_url ?>/account/style/paramount.css" type="text/css" rel="stylesheet" />
<link href="<?php echo $website_url ?>/account/style/main-style.css" type="text/css" rel="stylesheet" />
<link href="<?php echo $website_url ?>/account/style/scrollbar.css" type="text/css" rel="stylesheet" />
<link href="<?php echo $website_url ?>/account/style/nav-style.css" type="text/css" rel="stylesheet" />
...
<script src="<?php echo $website_url ?>/account/js/scripts.js"></script>
