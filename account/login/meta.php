...
<link href="<?php echo $website_url?>/account/login/style/paramount.css" type="text/css" rel="stylesheet" />
<link href="<?php echo $website_url?>/account/login/style/main-style.css" type="text/css" rel="stylesheet" />
...
<script src="<?php echo $website_url?>/account/login/js/session.js"></script>   
<script src="<?php echo $website_url?>/account/login/js/scripts.js"></script>   
