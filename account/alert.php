...
<div class="sidenavdiv">
        <div class="sidenavdiv-in" onclick="_closeSideNav()"> <div class="close-div" onclick="_closeSideNav()">X</div></div>
    ...
    <div class="sidenavdiv-menu" id="menu-list-div"> 
        ...
        <div class="div">
            <li class="active-li" onClick="_getPageMobile('dashboard','dashboard')" id="mobile-dashboard"><i class="bi-speedometer2"></i> Dashboard</li>
        </div>

        <div class="div">
            <li onClick="_getPageMobile('subjects','subjects')" id="mobile-subjects"> <i class="bi-pencil-square"></i> Subjects</li>
        </div>

        <div class="div">
            <li onClick="_getPageMobile('subscription','subscriptions')" id="mobile-subscriptions"> <i class="bi-box-arrow-in-up-right"></i> Subcription</li>
        </div>

        <div class="div">
            <li onClick="_getPageMobile('transactions','transactions')" id="mobile-transactions"> <i class="bi-credit-card"></i> Transactions</li>
        </div>
        ...
        <div class="div">
            <li onClick="_getPageMobile('wallet_history','wallet_history')" id="mobile-wallet_history"> <i class="bi-credit-card"></i> Wallet History</li></li>
        </div>
