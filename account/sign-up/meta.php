...
<link href="<?php echo $website_url ?>/account/sign-up/style/paramount.css" type="text/css" rel="stylesheet" />
<link href="<?php echo $website_url ?>/account/sign-up/style/main-style.css" type="text/css" rel="stylesheet" />
...
<script src="<?php echo $website_url ?>/account/sign-up/js/session.js"></script>
<script src="<?php echo $website_url ?>/account/sign-up/js/scripts.js"></script>
