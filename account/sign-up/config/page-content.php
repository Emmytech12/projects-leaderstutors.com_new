...
<?php if ($page == 'signup') { ?>
    ...
    <div class="fill-form-div animated fadeIn" id="nextPage1">
        ...
        <input type="tel" class="text-field" id="reg_mobile_no" onkeypress="_isNumberCheck('reg_mobile_no', 'mobile_info')" placeholder="ENTER YOUR PHONE NUMBER" />
    ...
    <div class="fill-form-div animated fadeIn" id="nextPage3">
        ...
        <input type="tel" class="text-field" id="referral_code" placeholder="ENTER YOUR REFERRAL-CODE" />
